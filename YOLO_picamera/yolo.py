...
# YOLO 파일 위치
LABELS_FILE = '/home/rasberry/YOLO_picamera/obj.names'
CONFIG_FILE = '/home/rasberry/YOLO_picamera/yolov3-tiny-obj.cfg'
WEIGHTS_FILE = '/home/rasberry/YOLO_picamera/yoloweight.weights'
...
class Yolo:
    ...
    def __init__(self):
        # 카메라
        self.cap = cv2.VideoCapture("your_MJPEG_ACTION_STREAM_ADDRESS")
